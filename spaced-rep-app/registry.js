 ...
 */
const GAMES = [
    { id: 'cards', title: 'Cards', icon: '🎴', color: '#2563eb', page: 'cards/cards.html' },
    { id: 'quiz', title: 'Quiz', icon: '🧩', color: '#0284c7', page: 'quiz/quiz.html' },
    { id: 'snake', title: 'Snake', icon: '🐍', color: '#059669', page: 'snake/snake.html' }
];
